...
class ManajerOperasionalHomeFragment : Fragment() {
    private var _binding: FragmentManajerOperasionalHomeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentManajerOperasionalHomeBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnPresensi.setOnClickListener {
            val movePresensi = Intent(this@ManajerOperasionalHomeFragment.context, PresensiInstrukturActivity::class.java)
            startActivity(movePresensi)
        }
