...
import com.example.gofit_10587.databinding.ActivityHistoryBookingGymBinding
import com.example.gofit_10587.models.BookingGym
import com.shashank.sony.fancytoastlib.FancyToast
import org.json.JSONObject
import java.nio.charset.StandardCharsets

class HistoryBookingGym : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.back.setOnClickListener{
            val move = Intent(this@HistoryBookingGym, HomeActivity::class.java)
            startActivity(move)
        }
