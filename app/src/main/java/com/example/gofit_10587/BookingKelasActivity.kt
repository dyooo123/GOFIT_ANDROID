...
import com.example.gofit_10587.databinding.ActivityBookingKelasBinding
...
class BookingKelasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.back.setOnClickListener{
            val move = Intent(this@BookingKelasActivity, HomeActivity::class.java)
            startActivity(move)
        }
    ...
    fun cancelBooking(id: String) {
        val stringRequest: StringRequest = object :
            StringRequest(Method.DELETE, BookingKelasApi.BATALKELAS + id, Response.Listener { response ->
                var jo = JSONObject(response.toString())
